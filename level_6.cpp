...
void CalcEvents(TResultEvents &inEvents, CLocationRef &loc, VCTIME vcStart, VCTIME vcEnd)
{
	VCTIME vc;
	SUNDATA sun;
	int ndst = 0;
...
void CalcSamskaras(TResultEvents &inEvents, CLocationRef &loc, VCTIME vcStart, VCTIME vcEnd)
{
	VCTIME vc;
	SUNDATA sun;
	int ndst = 0;
	...
	CalcEvents(inEvents, loc, vcStart, vcEnd);
